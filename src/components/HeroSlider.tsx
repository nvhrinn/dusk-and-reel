          ...
          >
            ...
            <div className="flex gap-3 mt-6">
              ...
              <Button
                size="lg"
                variant="secondary"
                className="glass-clear font-display"
                onClick={() => navigate(`/anime/${slide.id}`)}
              >
      ...
      {slides.length > 1 && (
        <>
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-2xl glass-sm flex items-center justify-center text-foreground hover:bg-secondary transition-colors"
          >
            <ChevronLeft className="w-5 h-5" />
          </button>
          <button
            onClick={() => goTo((current + 1) % slides.length)}
            className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-2xl glass-sm flex items-center justify-center text-foreground hover:bg-secondary transition-colors"
          >
